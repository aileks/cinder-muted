...
The script copies `Cinder-Muted-Dark` to `~/.local/share/themes/`, writes the libadwaita overlay into `~/.config/gtk-4.0/gtk.css` (backing up any existing file), and points gsettings at the theme. Restart GTK apps afterwards.
