...
(deftheme cinder-muted
  "Cinder Muted: warm, muted dark theme with ember-orange accents."
...
(defconst cinder-muted-bg        "#16110f")
(defconst cinder-muted-container "#1f1714")
(defconst cinder-muted-surface   "#281e19")
(defconst cinder-muted-visual    "#46372f")
(defconst cinder-muted-muted     "#624f46")
(defconst cinder-muted-subtle    "#a78e82")
(defconst cinder-muted-secondary "#b99f93")
(defconst cinder-muted-fg        "#c9aea0")
(defconst cinder-muted-bright    "#eccfc1")
(defconst cinder-muted-orange    "#f09361")
(defconst cinder-muted-green     "#df8452")
(defconst cinder-muted-red       "#a45751")
(defconst cinder-muted-yellow    "#ffa474")
(defconst cinder-muted-blue      "#ac5621")
(defconst cinder-muted-purple    "#bd6532")
(defconst cinder-muted-cyan      "#ce7442")
